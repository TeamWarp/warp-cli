...
This is a generated TypeScript CLI for Warp API, produced by the Scalar SDK Generator (https://scalar.com).
...
If the issue is in the Warp API or service rather than in this CLI, report it through the security process Warp API has published.
