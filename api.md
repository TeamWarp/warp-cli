...
```sh
warpapi custom-worker-fields create --api-key "$WARP_API_KEY" --name 'name' --type 'text' --category 'info'
```
...
```sh
warpapi custom-worker-fields retrieve 'cf_1234' --api-key "$WARP_API_KEY"
```
...
```sh
warpapi custom-worker-fields update 'cf_1234' --api-key "$WARP_API_KEY"
```
...
```sh
warpapi custom-worker-fields archive 'cf_1234' --api-key "$WARP_API_KEY"
```
...
```sh
warpapi custom-worker-fields create-option 'cf_1234' --api-key "$WARP_API_KEY" --label 'label' --value 'value'
```
...
```sh
warpapi custom-worker-fields update-option 'cfo_1234' --api-key "$WARP_API_KEY"
```
...
```sh
warpapi custom-worker-fields delete-option 'cfo_1234' --api-key "$WARP_API_KEY"
```
...
```sh
warpapi custom-worker-fields archive-option 'cfo_1234' --api-key "$WARP_API_KEY"
```
...
```sh
warpapi custom-worker-fields list-values --api-key "$WARP_API_KEY"
```
...
```sh
warpapi custom-worker-fields upsert-value --api-key "$WARP_API_KEY" --worker-id 'wrk_1234' --field-id 'cf_1234' --value '{"type":"text","value":""}'
```
...
```sh
warpapi custom-worker-fields clear-value --api-key "$WARP_API_KEY" --worker-id 'wrk_1234' --field-id 'cf_1234'
```
