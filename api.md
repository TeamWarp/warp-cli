...
```sh
warpapi custom-fields create --api-key "$WARP_API_KEY" --name 'name' --type 'text' --category 'info'
```
...
```sh
warpapi custom-fields retrieve 'cf_1234' --api-key "$WARP_API_KEY"
```
...
```sh
warpapi custom-fields update 'cf_1234' --api-key "$WARP_API_KEY"
```
...
```sh
warpapi custom-fields archive 'cf_1234' --api-key "$WARP_API_KEY"
```
...
```sh
warpapi custom-fields create-option 'cf_1234' --api-key "$WARP_API_KEY" --label 'label' --value 'value'
```
...
```sh
warpapi custom-fields update-option 'cfo_1234' --api-key "$WARP_API_KEY"
```
...
```sh
warpapi custom-fields delete-option 'cfo_1234' --api-key "$WARP_API_KEY"
```
...
```sh
warpapi custom-fields archive-option 'cfo_1234' --api-key "$WARP_API_KEY"
```
...
```sh
warpapi custom-fields upsert-value --api-key "$WARP_API_KEY" --worker-id 'wrk_1234' --field-id 'cf_1234' --value '{"type":"text","value":""}'
```
...
```sh
warpapi custom-fields clear-value --api-key "$WARP_API_KEY" --worker-id 'wrk_1234' --field-id 'cf_1234'
```
