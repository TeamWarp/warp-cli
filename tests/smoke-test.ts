...
const cases: { operation: string; method: string; path: string; args: string[] }[] = [
...

  {
    ...
    args: ["workers","create-employee","--first-name","firstName","--last-name","lastName","--position","position","--start-date","2000-01-01","--email","john@joinwarp.com","--department-id","dpt_1234","--manager-id","wrk_1234","--work-location","{\"type\":\"office\",\"workplaceId\":\"wkp_1234\"}","--compensation","{\"amount\":0,\"per\":\"hour\"}"],
  },

  {
    ...
    args: ["workers","create-contractor","--entity-type","individual","--first-name","firstName","--last-name","lastName","--position","position","--start-date","2000-01-01","--email","john@joinwarp.com","--department-id","dpt_1234","--manager-id","wrk_1234","--work-country","AD"],
  },
...

  {
    ...
    method: "POST",
    path: "/v1/workplaces",
    args: ["workplaces","create","--name","name","--type","remote","--address","{\"line1\":\"x\",\"city\":\"\",\"postalCode\":\"\",\"state\":\"AL\",\"country\":\"US\"}"],
  },
